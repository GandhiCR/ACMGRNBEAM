...
Public Class grnreport
    ...
    Dim itemcode, sizecode, itemname As String
    ...
    Public Sub grnwise()
        ...
        Dim sql1 As String = "SELECT SUBGRNNO as [GRN Number],convert(varchar(30),docdate,105) as [Created Date],VENNAME as [Vendor Name],ITEMCODE as [Item Code],GRNQTY as [GRN Qty.],GRNMTRS as [GRN Mtrs.],BATCHNO as [Batch],AUTONUM as [Thaan No.],SETNO as [Set No],BEAMNO as [Beam No],LOOMNO as [Loom No],THORNEQTY as [Thaan Qty.],THORNEMTRS as [Thaan Mtrs],THRONECOLOR as [Color]  FROM SUBGRNBEAM where subgrnno = '" & txtgrnno.Text & "' order by DOCENTRY asc"
    ...
    Public Sub datewise()
        ...
        If dt1.Rows.Count > 0 Then
            ...
            Dim query = invgrid.Rows.Cast(Of GridViewRow).
       GroupBy(Function(g) New With {Key .Color = g.Cells(7).Text}).
       Select(Function(group) New With {
                                 group.Key.Color,
                                 .Totalthaan = group.Count,
                          .Quantity = group.Sum(Function(a) a.Cells(12).Text),
        ...
        Else
            ...
            invgrid.DataBind()
            lblmsg.Text = "No Data Found"
            summarygrid.DataSource = Nothing
            summarygrid.DataBind()
            lbl1.Visible = False
