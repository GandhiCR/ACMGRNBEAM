<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="grnreport.aspx.vb" Inherits="ACMGRNBEAM.grnreport" %>
...
<table id="emptable" style="width:600px" >
                     ...
                     <tr>
                        ...
                        <asp:textbox id="txtfromdate" runat="server" MaxLength="21" Width="100px" autocomplete ="Off"  Font-Names="Times New Roman" Font-Size="15px" Height="25px" ReadOnly="True" ></asp:textbox>   
                        </td>
                         </tr> 
                    <tr>
                <td style="width:120px;text-align:right">
                    ...
                    <td>
                        ...
                        <asp:textbox id="txttodate" runat="server" MaxLength="21" Width="100px" autocomplete ="Off"  Font-Names="Times New Roman" Font-Size="15px" Height="25px" ReadOnly="True" ></asp:textbox> 
      ...
      <tr>
           ...
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                         <td style="width:200px;text-align:center">
                               <asp:textbox id="txtgrnno" runat="server" MaxLength="21" Width="100px" autocomplete ="Off"  Font-Names="Times New Roman" Font-Size="25px" Height="25px" Visible="False" ></asp:textbox>      
                            </td>
    ...
    <Columns>
       ...
       <%--   <asp:BoundField DataField="subgrnno" HeaderText="GRN No" />
                     <asp:BoundField DataField="Vencode" HeaderText="Vendor Code" />
              <asp:BoundField DataField="venname" HeaderText="Vendor Name" />
              <asp:BoundField DataField="newitemcode" HeaderText="Item Code" />
         <asp:TemplateField HeaderText="Item Name" >
                        <ItemTemplate>
                                    <asp:Label ID="lblitemname" runat="server"   CssClass="QuantityClass" ></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
          <asp:BoundField DataField="thronecolor" HeaderText="Color" />
          <asp:TemplateField HeaderText="Sizing Code" >
                        <ItemTemplate>
                                    <asp:Label ID="lblsizecode" runat="server"   CssClass="QuantityClass" ></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
