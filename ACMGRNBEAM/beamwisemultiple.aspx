<%@ Page Title="" Language="vb" EnableViewState="true" ViewStateEncryptionMode="Always" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="beamwisemultiple.aspx.vb" Inherits="ACMGRNBEAM.BEAMWISEMULTIPLE" %>
...
grid-row-gap: 0px;
    ...
    <table border="0" style="width:600px">
        <tr>
                <td colspan="5" style="text-align:center;border:dotted ">
                     ...
                     <asp:Label ID="lbltitle" runat="server" Text="BEAMWISE SUMMARY ENTRY - MULTIPLE PRODUCT"  Font-Names="Berlins Sans FB"  Font-Bold="True" Font-Size="22px" ForeColor="Aqua" ></asp:Label>  
                  
                </td>
            </tr>
        </table>
      </center>
    <table id="grntable" style="width: 1200px">
        <tr>
          <td colspan="8" style="text-align:center" >
                <strong>
                    <asp:Label ID="Label11" runat="server" Text="SUB. GOODS RECEIPT NO" Font-Names="Century Gothic" Font-Size="20px" ForeColor="#FF9900"></asp:Label>
                     </strong>
          &nbsp;&nbsp;&nbsp;
              ...
              &nbsp;&nbsp;&nbsp;
                <asp:Button ID="btngrnget" class="button" runat="server" Text="GET" Visible="False" />
            </td>
        </tr>
        </table>
    <table>
            ...
            <td>
                <center>
                    ...
                    <br />
                <asp:GridView ID="GridView1" runat="server" BackColor="LightGoldenrodYellow"  BorderColor="Tan" BorderWidth="1px" CellPadding="2">
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:RadioButton ID="chkRow" runat="server" OnCheckedChanged="radio_Changed" AutoPostBack="true" onclick="RadioCheck(this);" />
                            </ItemTemplate>
                        </asp:TemplateField>
                    ...
                    <RowStyle Font-Names="Times New Roman" Font-Size="20px" CssClass="Gridrow"  BackColor="#99ccff" />
    ...
    <asp:Panel ID="grnpanel" runat="server" Visible ="false"  >
        <table id="grntable1" style="width: 1200px">
        <tr>
            <td style="width: 280px">
                <strong>
                    <asp:Label ID="lblgrn" runat="server" Text="SUB. GOODS RECEIPT NO" Font-Names="Century Gothic" Font-Size="20px" ForeColor="#FF9900"></asp:Label>
                 </strong>
            </td>
            <td style="width: 2px">
            ...
            <td style="width: 300px">
                 <asp:Label ID="lblgrnno" runat="server" Font-Names="Times New Roman" Font-Size="25px" ForeColor="White"></asp:Label>
                 &nbsp;&nbsp;&nbsp;
        ...
        <tr>
            ...
            <td style="text-align: LEFT">
                <asp:Label ID="lblitemcode" runat="server" Font-Names="Times New Roman" Font-Size="25px" ForeColor="White"></asp:Label>
            </td>
            <td style="width: 2px">&nbsp;&nbsp;&nbsp;
            </td>
            <td style="width: 120px">
        ...
        <tr>
            ...
            <td style="width: 120px">
                <strong>
                    ...
                    <asp:Label ID="Label28" runat="server" Text="NEW ITEM CODE" Font-Names="Century Gothic" Font-Size="20px" ForeColor="#FF9900"></asp:Label>
                </strong>
            </td>
            <td style="width: 2px">
        ...
        <tr>
            <td style="width: 150px; text-align: left">
                <strong>
                    <asp:Label ID="Label16" runat="server" Text="LENGTH" Font-Names="Century Gothic" Font-Size="20px" ForeColor="#FF9900"></asp:Label>
                </strong>
            </td>

            <td style="width: 2px">
                <asp:Label ID="Label17" runat="server" Text=":" Font-Names="Berlin Sans FB" Font-Size="30px" ForeColor="White"></asp:Label>
            </td>
            <td style="text-align:left">
            ...
            <td style="width: 120px">
                <strong>
                    <asp:Label ID="Label29" runat="server" Text="GRN BY" Font-Names="Century Gothic" Font-Size="20px" ForeColor="#FF9900" CssClass="auto-style1"></asp:Label>
                </strong>
            </td>
            <td style="width: 2px">
        ...
        <table>
          <tr>
            ...
            <td>
             ...
             <td>
                  <asp:TextBox ID="txtsetno" runat="server" Font-Names="Times New Roman" Font-Size="24px"  AutoCompleteType="Disabled" Width="150px"  onkeypress="return numeric(event);" ></asp:TextBox>
            </td>
             ...
             <td>
                  <asp:TextBox ID="txtbeamno" runat="server" Font-Names="Times New Roman" Font-Size="24px"  AutoCompleteType="Disabled" Width="150px"  onkeypress="return numeric(event);" ></asp:TextBox>
            </td>
             ...
             <td>
                  <asp:TextBox ID="txtloomno" runat="server" Font-Names="Times New Roman" Font-Size="24px"  AutoCompleteType="Disabled" Width="150px"></asp:TextBox>
            </td>
            ...
            <tr>
             ...
             <td>
                  <asp:TextBox ID="txtthorneqty" runat="server" Font-Names="Times New Roman" Font-Size="24px"  AutoCompleteType="Disabled" Width="150px" AutoPostBack="True" ></asp:TextBox>
            </td>   
             ...
             <td>
                   <asp:TextBox ID="txtmtrs" runat="server" Font-Names="Times New Roman" Font-Size="24px"  AutoCompleteType="Disabled" Width="150px" AutoPostBack="True"  ></asp:TextBox>
            </td>   
...
<asp:DropDownList ID="cmbcolor" runat="server"  AutoPostBack="true" Font-Names="Berlin Sans FB" Font-Size="20px" >
