<%@ Page Title="" Language="vb" EnableViewState="true" ViewStateEncryptionMode="Always" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="inspectiondisplay.aspx.vb" Inherits="ACMGRNBEAM.inspectiondisplay" EnableEventValidation = "false"  %>
...
<script type="text/javascript">
        $(function () {
            $(".Country").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: 'inspectiondisplay.aspx/Getitemcode',
    ...
    <table border="0" style="width:600px">
        <tr>
                <td colspan="5" style="text-align:center;border:dotted ">
                     ...
                     <asp:Label ID="lbltitle" runat="server" Text="BEAMWISE INSPECTION ENTRY - DISPLAY"  Font-Names="Berlins Sans FB"  Font-Bold="True" Font-Size="24px" ForeColor="Aqua" ></asp:Label>  
    ...
    <asp:Panel ID="Formulapanel" runat="server" Visible ="false">
<table  border="1" >
    <tr>
        <td colspan="5"  style="text-align:center">
              <asp:Label ID="Label41" runat="server"  Font-Size="30px" ForeColor="#FFCCFF" Text="FORMULAS USED"  Font-Names="Agency FB" ></asp:Label><br /> 
        </td>
    </tr>
                            <tr>
                                                            
                               <td>
                                    <asp:Label ID="Label45" runat="server"  Font-Size="30px" ForeColor="#FFCCFF" Text="A Mtrs"  Font-Names="Agency FB"   ></asp:Label><br /> 
                                </td>
                               
                                <td>
                                    <asp:Label ID="Label46" runat="server"  Font-Size="30px" ForeColor="#FFCCFF" Text="B Mtrs"  Font-Names="Agency FB"   ></asp:Label><br /> 
                                </td>
                                  <td>
                                    <asp:Label ID="Label47" runat="server"  Font-Size="30px" ForeColor="#FFCCFF" Text="C Mtrs"  Font-Names="Agency FB"   ></asp:Label><br /> 
                                </td>
                               
                                <td>
                                    <asp:Label ID="Label48" runat="server"  Font-Size="30px" ForeColor="#FFCCFF" Text="Bit Mtrs"  Font-Names="Agency FB"   ></asp:Label><br /> 
                                </td>
                                   <td style="text-align:center">
                                    <asp:Label ID="Label49" runat="server"  Font-Size="30px" ForeColor="#FFCCFF" Text="Weight"  Font-Names="Agency FB"  ></asp:Label><br /> 
                                </td>
                                </tr>
                            <tr>
                                <td style="text-align:center">
                                    <asp:Label ID="lblforamtrs" runat="server"  Font-Size="30px" ForeColor="White" Font-Names="Agency FB"   Text="A Qty x Size"></asp:Label>
                                </td>
                               
                                <td style="text-align:center">
                                    <asp:Label ID="lblforbmtrs" runat="server"  Font-Size="30px" ForeColor="White" Font-Names="Agency FB"   Text="B Qty x Size"></asp:Label>
                                </td>
                               <td style="text-align:center">
                                    <asp:Label ID="lblforcmtrs" runat="server"  Font-Size="30px" ForeColor="White" Font-Names="Agency FB"   Text="C Qty x Size"></asp:Label>
                                </td>
                               
                                <td style="text-align:center">
                                    <asp:Label ID="lblforbitmtrs" runat="server"  Font-Size="30px" ForeColor="White" Font-Names="Agency FB"   Text="Bit Qty"></asp:Label>
                                </td>
                                 <td style="text-align:center">
                                    <asp:Label ID="lblforweight" runat="server"  Font-Size="30px" ForeColor="White" Font-Names="Agency FB"   Text="WarpCons + WeftCons x TotalMtrs."></asp:Label>
                                </td>
    ...
    <table>
        <tr>
            <td style="text-align:center">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="btnsave" class="button" runat="server" Text="UPDATE DETAILS" Width="200px" Visible="False" />
                  &nbsp;&nbsp;&nbsp;&nbsp;
                 <asp:Button ID="btnitem" class="button" runat="server" Text="UPDATE ITEMCODE" Width="180px"/>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="btnerror" class="button" runat="server" Text="DAMAGE ENTRY" Width="180px"/>
                   &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="btnexport" class="button" runat="server" Text="EXPORT TO EXCEL" Width="180px" Visible="false"/>
                  &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="btncolor" class="button" runat="server" Text="UPDATE COLOR ONLY" Width="250px"/>
    ...
        CancelControlID="Button1" BackgroundCssClass="modalBackground" >  
        ...
        <tr>
            <td style="vertical-align: top">
                ...
                <asp:Panel ID="contenpanel" runat="server" Visible="false" CssClass="scrollbar" ScrollBars ="Vertical" >
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" CellPadding="2" ShowFooter ="true">
                        <Columns>
                            ...
                            <asp:BoundField DataField="THORNEQTY" HeaderText="GRN Quantity" >
...
<asp:listitem>OX39-VIOLET</asp:listitem>
                             ...
                             <asp:TemplateField HeaderText="Size">
                                   <ItemTemplate>
                                    <asp:TextBox ID="txtlength" CssClass="QuantityClass" runat="server" Text='<%# Eval("THRONESIZE")  %>' autocomplete ="Off" Width="30px" onclick="selectAllText(this)"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                             <asp:TemplateField HeaderText="Width" >
                                   <ItemTemplate >
                                    <asp:TextBox ID="txtwidth" CssClass="QuantityClass" runat="server" autocomplete ="Off" Width="35px"  Text = <%# Convert.ToDouble((Eval("THRONEWIDTH"))).ToString("#####0.00") %>  onclick="selectAllText(this)"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                             <asp:TemplateField HeaderText="Reed Space">
                                   <ItemTemplate>
                                    <asp:TextBox ID="txtreed" CssClass="QuantityClass" runat="server" Text='<%# Eval("THRONEREEDSPACE")  %>' autocomplete ="Off" Width="35px"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                             <asp:TemplateField HeaderText="Pick">
                                   <ItemTemplate>
                                    <asp:TextBox ID="txtpick" CssClass="QuantityClass" runat="server" Text='<%# Eval("THRONEPICK")  %>'  autocomplete ="Off" Width="35px" onclick="selectAllText(this)"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText=" A Qty.">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtAQuantity" CssClass="QuantityClass" runat="server"  Text='<%# Eval("AQTY")  %>' autocomplete ="Off" Width="40px" onclick="selectAllText(this)"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText=" B Qty.">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtBQuantity" CssClass="QuantityClass" runat="server"  Text='<%# Eval("BQTY")  %>' autocomplete ="Off" Width="40px" onclick="selectAllText(this)"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText=" C Qty.">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtCQuantity" CssClass="QuantityClass" runat="server"  Text='<%# Eval("CQTY")  %>' autocomplete ="Off" Width="40px" onclick="selectAllText(this)"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText=" Bit Qty.">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtDQuantity" CssClass="QuantityClass" runat="server"   Text='<%# Eval("BITQTY")  %>' autocomplete ="Off" Width="40px"  onclick="selectAllText(this)"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Total Qty.">
                              
                                <ItemTemplate>
                                    <asp:Label ID="lbltotthqty" runat="server"  Text='<%# Eval("TOTALQTY")  %>'  CssClass="QuantityClass"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                         <asp:TemplateField HeaderText="A Mtrs" HeaderStyle-Width="60px">
                                  <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                <ItemTemplate>
                                    <asp:LABEL ID="txtthaanmtrsa" CssClass="QuantityClass" runat="server" Text='<%# Eval("AMTRS")  %>' autocomplete ="Off" Width="40px" onclick="selectAllText(this)"></asp:LABEL>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="B Mtrs" HeaderStyle-Width="60px">
                                  <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                <ItemTemplate>
                                    <asp:Label  ID="txtthaanmtrsb" CssClass="QuantityClass" runat="server" Text='<%# Eval("BMTRS")  %>' autocomplete ="Off" Width="40px" onclick="selectAllText(this)"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="C Mtrs" HeaderStyle-Width="60px">
                                  <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                <ItemTemplate>
                                    <asp:Label  ID="txtthaanmtrsc" CssClass="QuantityClass" runat="server" Text='<%# Eval("CMTRS")  %>' autocomplete ="Off" Width="40px" onclick="selectAllText(this)" ></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Bit Mtrs" HeaderStyle-Width="60px">
                                  <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                <ItemTemplate>
                                    <asp:Label ID="txtthaanmtrsd" CssClass="QuantityClass" runat="server" Text='<%# Eval("BITMTRS")  %>' autocomplete ="Off" Width="40px" ></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Total Mtrs." >
                                 <ItemStyle HorizontalAlign="Right"></ItemStyle>
                             <ItemTemplate>
                                    <asp:Label ID="lbltotthmtrs" runat="server" Text='<%# Eval("TOTALMTRS")  %>'  CssClass="QuantityClass" ></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                              <asp:TemplateField HeaderText="TL. Mtrs." HeaderStyle-Width="60px">
                                  <ItemTemplate>
                                    <asp:TextBox ID="txttapelength" CssClass="QuantityClass" runat="server" Text='<%# Eval("TAPELENGTH")  %>'  autocomplete ="Off" Width="40px" onclick="selectAllText(this)"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                             ...
                             <asp:BoundField DataField="loomno" HeaderText="Loom No" >
                              ...
                              <asp:TemplateField HeaderText="Weight [Kgs]" HeaderStyle-Width="60px">
                                   <ItemTemplate>
                                    <asp:TextBox ID="txtweight" CssClass="QuantityClass" runat="server" Text='<%# Eval("WEIGHT")  %>' autocomplete ="Off" Width="40px" onclick="selectAllText(this)"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
