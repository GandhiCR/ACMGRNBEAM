...
Public Class ADDITIONAL_WEAVING_CONSUMPTION_LAYOUT_DAYS
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ADDITIONAL WEAVING CONSUMPTION LAYOUT DAYS.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ACMGRNBEAM.ADDITIONAL WEAVING CONSUMPTION LAYOUT DAYS.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_fd() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_td() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_VENSELECT_ALL_UNION_ALL_SELECT_CardName___FROM_OCRD__WHERE_GroupCode_103() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedADDITIONAL_WEAVING_CONSUMPTION_LAYOUT_DAYS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ADDITIONAL_WEAVING_CONSUMPTION_LAYOUT_DAYS = New ADDITIONAL_WEAVING_CONSUMPTION_LAYOUT_DAYS()
        rpt.Site = Me.Site
        Return rpt
    End Function
